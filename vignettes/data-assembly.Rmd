...
- **Missing concentrations**: a dosed timepoint whose replicates carry no
  measured concentration is dropped. Averaging them gives `NaN`, and the
  row cannot contribute to an exposure-response analysis.
