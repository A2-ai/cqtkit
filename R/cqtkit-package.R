...
#'     QT corrections
#'   \item \code{\link{compute_blm}}: Add a population mean baseline value
#'     for an ECG parameter from a baseline dataset
...
#'     Tmax, etc.)
#'   \item \code{\link{compute_high_qtc_subjects}}: Count subjects with at
#'     least one observation exceeding QTc thresholds
#'   \item \code{\link{compute_high_qtc_observations}}: Count observations
#'     exceeding QTc thresholds
#'   \item \code{\link{compute_high_qtc_sub}}: Deprecated, use
#'     \code{compute_high_qtc_subjects()}
...
#'   \item \code{\link{tabulate_high_qtc_subjects}}: High QTc subject counts
#'     table
#'   \item \code{\link{tabulate_high_qtc_observations}}: High QTc observation
#'     counts table
#'   \item \code{\link{tabulate_high_qtc_sub}}: Deprecated, use
#'     \code{tabulate_high_qtc_subjects()}
...
#' argument. Multi-panel plots built with a style specification return an
#' editable patchwork, so \code{restyle_plot()} and \code{reveal()} can update
#' their panels. The deprecated list style retains the legacy ggpubr return
...
#'	\item \code{\link{compute_blm}} - This function adds a population mean baseline value for an ECG parameter from a baseline dataset
...
#' 	\item \code{\link{compute_high_qtc_subjects}} - This function computes the number of subjects with at least one high QTc observation.
#' 	\item \code{\link{compute_high_qtc_observations}} - This function computes the number of observations with high QTc values.
#' 	\item \code{\link{compute_high_qtc_sub}} - Deprecated, use \code{compute_high_qtc_subjects()}.
...
#' 	\item \code{\link{tabulate_high_qtc_subjects}} - This function generates a table of the number of subjects with at least one high QTc observation.
#' 	\item \code{\link{tabulate_high_qtc_observations}} - This function generates a table of the number of observations with high QTc values.
#' 	\item \code{\link{tabulate_high_qtc_sub}} - Deprecated, use \code{tabulate_high_qtc_subjects()}.
