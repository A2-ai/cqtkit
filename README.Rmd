...
The included `cqtkit_data_<drug>` datasets already contain preprocessed data that has been averaged across replicates, so they include many of the derived columns that `preprocess()` would typically create. However, `preprocess()` can still be useful to compute any missing derived parameters.
